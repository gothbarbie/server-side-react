...
app.get('*', function (req, res) {
  var store = (0, _createStore2.default)(); // Create store outside of rendering
...
exports.default = [_extends({}, _HomePage2.default, { // has 'component' prop inside it
  path: '/',
  exact: true
}), _extends({}, _UsersListPage2.default, { // has 'component' and 'loadData' inside it
  path: '/users'
})];
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _axios2.default.get(API_URL + '/users');
